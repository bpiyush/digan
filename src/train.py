...
def setup_training_loop_kwargs(
    ...
    cfg_specs = {
        ...
        'pouring':   dict(ref_gpus=4,  kimg=100000, mb=16, mbstd=32, fmaps=1,   lrate=0.0025, r1_gamma=0.01, ema=500, ramp=0.05, map=2),
    }
...
# Base config.
@click.option('--cfg', help='Base config [default: auto]', type=click.Choice(['auto', 'stylegan2', 'paper256', 'paper512', 'paper1024', 'cifar', 'pouring']))
